...
//			return new User("author", "{bcrypt}$2a$10$Ou57ZyqxRq4DCc813FQNp.pTyrMIM1JewuPSY5.mPkjyICpQoyiLW", new ArrayList<>());
...
//			return new User("reader", "{bcrypt}$2a$10$yxLyRvPQGopgxzCL84j8X.srY6xh.jzKDNCdOB8pmXkP5SG7cnu3W", new ArrayList<>());
